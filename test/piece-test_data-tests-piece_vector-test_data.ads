...
package Piece.Test_Data.Tests.Piece_Vector.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Piece.Piece_Vector.Test_Data (Test);
...
end Piece.Test_Data.Tests.Piece_Vector.Test_Data;
