...
package Common_Types.Test_Data.Tests.Position_Vector.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Common_Types.Position_Vector.Test_Data (Test);
...
end Common_Types.Test_Data.Tests.Position_Vector.Test_Data;
