...
--  begin read only
--  end read only
package body Pawn.Test_Data.Tests is
...
--  begin read only
   ...
   procedure Test_Make_d01003 (Gnattest_T : in out Test) renames Test_Make;
--  id:2.2/d0100393781f4ae4/Make/1/0/
...
--  end read only
   ...
   begin
    ...
    declare
      Black_Object : Pawn.Object_Access := Pawn.Make (Common_Types.Black, ('A', 1));
    begin
    ...
    declare
      White_Object : Pawn.Object_Access := Pawn.Make (Common_Types.White, ('H', 8));
    begin
      AUnit.Assertions.Assert
