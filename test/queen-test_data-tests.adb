...
--  begin read only
--  end read only
package body Queen.Test_Data.Tests is
...
--  begin read only
   ...
   procedure Test_Make_036192 (Gnattest_T : in out Test) renames Test_Make;
--  id:2.2/036192724b6bdf93/Make/1/0/
...
--  end read only
   ...
   begin
    ...
    declare
      Black_Object : Queen.Object_Access := Queen.Make (Common_Types.Black, ('A', 1));
    begin
    ...
    declare
      White_Object : Queen.Object_Access := Queen.Make (Common_Types.White, ('H', 8));
    begin
      AUnit.Assertions.Assert
