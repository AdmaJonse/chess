...
--  begin read only
--  end read only
package body Rook.Test_Data.Tests is
...
--  begin read only
   ...
   procedure Test_Make_0d0788 (Gnattest_T : in out Test) renames Test_Make;
--  id:2.2/0d0788e564fd9978/Make/1/0/
