...
--  placed into Bishop.Object_Test_Data.
...
--  begin read only
--  end read only
package body Bishop.Object_Test_Data.Object_Tests is
...
--  end read only
    ...
    Test_Data : Test_Record :=
      (Position      => To_Position ("A1"),
       Valid_Moves   => (To_Position ("B2"), To_Position ("C3"), To_Position ("D4")),
       Invalid_Moves => (To_Position ("B1"), To_Position ("C1"), To_Position ("D1")));

    The_Piece : Bishop.Object_Access := Bishop.Make (White, Test_Data.Position);
...
--  end read only
    ...
    White_Piece   : constant Bishop.Object_Access       := Bishop.Make (Common_Types.White, Test_Position);
    Black_Piece   : constant Bishop.Object_Access       := Bishop.Make (Common_Types.Black, Test_Position);
    ...
    for Path of White_Piece.Get_Paths loop
      ...
      AUnit.Assertions.Assert
        (White_Piece.Is_Valid_Move (To => Path (Test_Position)),
         "Path specifies invalid move for White Bishop.");
    ...
    for Path of Black_Piece.Get_Paths loop
      ...
      AUnit.Assertions.Assert
        (Black_Piece.Is_Valid_Move (To => Path (Test_Position)),
         "Path specifies invalid move for Black Bishop.");
...
--  end read only
    ...
    White_Piece : constant Bishop.Object_Access := Bishop.Make (White, To_Position ("A1"));
    Black_Piece : constant Bishop.Object_Access := Bishop.Make (Black, To_Position ("A2"));

    White_Expected : constant String := (1 => 'B');
    Black_Expected : constant String := (1 => 'b');
